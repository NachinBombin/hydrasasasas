...
function ENT:Draw()
    ...
    render.AddBeam( Bpoints[1], 28, 0, Color( 255, 255, 255, 255 ) )
	for i = 2, (res - 1) do
		render.AddBeam( bres[i], 8, i, Color( 255, 255, 255, 255 ) )
	end
	render.AddBeam( bres[res], 12, 15, Color( 255, 255, 255, 255 ) )
	render.AddBeam( bres[res] + self:GetForward() * 15, 15, 15, Color( 255, 255, 255, 255 ) )
	render.EndBeam()
